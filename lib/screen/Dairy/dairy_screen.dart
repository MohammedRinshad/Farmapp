        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child:  Text("Describe your Dairy..?",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
            ),
            Padding(
              ...
              child: Center(
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Center(child: Text('Next',style: TextStyle(fontSize: 20,color: Colors.white),)),
                  ),
                  onTap: (){
